...
income_levels <- c("$0 to $4,999", "$5,000 to $9,999", "$10,000 to $14,999", "$15,000 to $19,999", "$20,000 to $24,999", "$25,000 to $34,999", "$35,000 to $44,999", "$45,000 to $54,999", "$55,000 to $64,999", "$65,000 to $74,999", "$75,000 to $99,999", "$100,000 and over")
...
\begin{table}[h!]
\centering
\caption{Table looking at the 4 model results}
\label{tab:table506} 
\begin{tabular}{lllll}
\hline
\textbf{Model} & \textbf{Estimated Incidence Risk Ratio} & \textbf{Sample Size} & \textbf{$R^2$} & \textbf{AIC value}\\
\hline
1R & 2 & 3 & 4 & 5 \\
2R & 2 & 3 & 4 & 5\\
1L & 2 & 3 & 4 & 5 \\
