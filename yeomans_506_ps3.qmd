...
\begin{tabular}{lccc}
\hline
\textbf{Model} & \textbf{Sample Size ($N = df_{null} + 1$)} & \textbf{Pseudo-$R^2$} & \textbf{AIC} \\
\hline
1R & 4149 & 7.774521e-05 & 96618 \\
2R & 3705 & 7.580697e-03  & 84650 \\
1L & 4103 & 1.481932e-04 & 98685 \\
2L & 3665 & 5.274216e-03  & 86397 \\
\hline
\end{tabular}
\end{table}
\vspace{.5cm}
...
\begin{table}[h!]
\centering
\caption{Estimated incidence risk ratios (IRRs) for each model rounded to 3 decimals}
\label{tab:coeffs}
\begin{tabular}{lcccc}
\hline
\textbf{Term} & \textbf{1R} & \textbf{2R} & \textbf{1L} & \textbf{2L} \\
\hline
Intercept & 84.317 & 83.557 & 84.758 & 85.121 \\
Gender - Female & 1.009 & 1.015 & 1.013 & 1.019 \\
Citizenship - Non-citizen & -- & 1.044 & -- & 1.018 \\
DMDHHSZA1 & -- & 0.997 & -- & 0.989 \\
DMDHHSZA2 & -- & 0.970 & -- & 0.969 \\
DMDHHSZA3 or more & -- & 1.056 & -- & 0.922 \\
INDHHIN2.L & -- & 0.954 & -- & 0.931 \\
INDHHIN2.Q & -- & 0.922 & -- & 0.984 \\
INDHHIN2.C & -- & 0.999 & -- & 1.024 \\
INDHHIN2$^4$ & -- & 1.022 & -- & 0.977 \\
INDHHIN2$^5$ & -- & 0.996 & -- & 0.992 \\
INDHHIN2$^6$ & -- & 1.054 & -- & 1.062 \\
INDHHIN2$^7$ & -- & 0.996 & -- & 0.977 \\
INDHHIN2$^8$ & -- & 1.030 & -- & 0.994 \\
INDHHIN2$^9$ & -- & 1.035 & -- & 1.007 \\
INDHHIN2$^{10}$ & -- & 0.979 & -- & 0.970 \\
INDHHIN2$^{11}$ & -- & 1.006 & -- & 0.950 \\
\hline
\end{tabular}
\end{table} 
\vspace{.5cm}
