...
unique(top_rentals[, c("film_id", "title", "amount")])
```
...
single_a
```
Site used <https://www.w3schools.com/sql/sql_count_avg_sum.asp>. 
...
single_c
```
This does not match my answer for c from the SQL and base R? This one has Scorpion Apollo showing up twice. 
